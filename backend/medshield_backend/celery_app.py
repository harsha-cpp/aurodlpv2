...
def create_celery() -> Celery:
    ...
    app = Celery(
        ...
        include=[
            "medshield_backend.celery_tasks.deep_scan",
            "medshield_backend.celery_tasks.quarantine_expiry",
            "medshield_backend.celery_tasks.audit_verifier",
        ],
    )
    ...
    config.update(
        ...
        beat_schedule={
            "quarantine-expiry": {
                "task": "medshield.quarantine.expire_pending",
                "schedule": 3600.0,
            },
            "audit-chain-verify": {
                "task": "medshield.audit.verify_chain",
                "schedule": 86400.0,
            },
        },
    )
