...
from blade_backend.audit.api import router as audit_router
from blade_backend.auth.api import router as auth_router
from blade_backend.auth.devices_api import router as devices_router
from blade_backend.auth.mfa_api import router as mfa_router
from blade_backend.domains.api import router as domains_router
from blade_backend.events.api import router as events_router
from blade_backend.members.api import router as members_router
from blade_backend.orgs.api import router as orgs_router
from blade_backend.policy.api import router as policy_router
from blade_backend.public.api import router as public_router
from blade_backend.quarantine.api import router as quarantine_router
from blade_backend.scan.api import router as scan_router
